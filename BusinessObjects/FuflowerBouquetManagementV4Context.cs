...
public partial class FuflowerBouquetManagementV4Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2B1EC81F7E");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8378BA2BF");
        ...
        {
            entity.HasKey(e => e.FlowerBouquetId).HasName("PK__FlowerBo__A1391301305D8284");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BAFD15E4756");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.FlowerBouquetId }).HasName("PK__OrderDet__C983CA9F9D6A44E3");
